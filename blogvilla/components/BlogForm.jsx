...
const BlogForm = ({ token }) => {
  ...
  return (
    <>
      <form className='flex flex-col gap-6 mb-5' onSubmit={handleSubmit} action={"/blogs"}>
        <div >
        ...
        <div>
          <button className='bg-green-500 px-3 py-1 rounded-lg' type="submit">Submit</button>
        </div>
      </form>
    </>
  )
